...
//CODE HERE
const empOne = new Employee('Rick', 'weekday mornings');
...
//CODE HERE
const employeeDouble = new Manager('Winston', 'mornings afternoons', ['Cece and Schmidt'])
...
//CODE HERE 
employeeDouble.addEmployee('Coach')
/*
    Call the `getEmployees` method on the
